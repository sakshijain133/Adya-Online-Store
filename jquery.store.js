(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.paypalBusinessEmail = "sakshijain0406@email.com"; // Your Business PayPal's account email address
			this.paypalURL = "https://play.google.com/store/apps/details?id=com.paypal.android.p2pmobile"; // The URL of the PayPal's form
